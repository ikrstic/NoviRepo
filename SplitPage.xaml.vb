...
Public NotInheritable Class SplitPage
    ...
    Protected Overrides Sub LoadState(navigationParameter As Object, pageState As Dictionary(Of String, Object))
        ...
        If pageState IsNot Nothing AndAlso pageState.ContainsKey("Title") Then
            feedTitle = DirectCast(pageState("Title"), String)
        End If
    ...
    Protected Overrides Sub SaveState(pageState As Dictionary(Of String, Object))
        If Me.itemsViewSource.View IsNot Nothing Then
            Dim selectedItem = Me.itemsViewSource.View.CurrentItem
            ...
            ' Save page title
            Dim feedData = DirectCast(Me.DefaultViewModel("Feed"), FeedData)
            pageState("Title") = feedData.Title
    ...
    Protected Overrides Function DetermineVisualState(viewState As ApplicationViewState) As String
        ...
        Dim logicalPageBack = Me.UsingLogicalPageNavigation(viewState) AndAlso Me.itemListView.SelectedItem IsNot Nothing
        Dim physicalPageBack = Me.Frame IsNot Nothing AndAlso Me.Frame.CanGoBack
        ...
        If viewState = ApplicationViewState.Filled OrElse
            ...
            Dim windowWidth = Window.Current.Bounds.Width
        ...
        Dim defaultStateName = MyBase.DetermineVisualState(viewState)
